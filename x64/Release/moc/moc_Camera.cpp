...
QT_MOC_LITERAL(3, 30, 18) // "baslerConditionMet"

    },
    "BaslerCamera\0showImageSignal\0\0"
    "baslerConditionMet"
};
...
void BaslerCamera::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->baslerConditionMet(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (BaslerCamera::*)(QImage );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BaslerCamera::showImageSignal)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BaslerCamera::baslerConditionMet)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void BaslerCamera::showImageSignal(QImage _t1)
{
...
// SIGNAL 1
void BaslerCamera::baslerConditionMet()
{
